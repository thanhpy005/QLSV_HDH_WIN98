...
public class GD_XemTienTrinh1 extends javax.swing.JFrame implements ActionListener {
    private SinhVien sv;
    
    private ArrayList list;
    DefaultTableModel m1, m2, m3, m4, m5, m6, m7, m8;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GD_XemTienTrinh1.class.getName());

    public GD_XemTienTrinh1(SinhVien sinhVien) {
        initComponents();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(BackButton)) {
            GD_Menu_SV1 winD_Menu_SV1 = new GD_Menu_SV1(sv);
            winD_Menu_SV1.setLocationRelativeTo(null);
            winD_Menu_SV1.setVisible(true);
            this.dispose();
        }
    }
}